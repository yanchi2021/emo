...
def fetch_features_vectorized(data_dir, features, corpus):
    def extract_feature(feature):
        # print('to_do_feature:',feature)
        data_dir='D:/下载/emotion_flow-master/emotion_flow-master/vectors'
        target_file = data_dir+'/'+ feature + '.pkl'
        target_index_file = data_dir+'/'+ feature + '_index.pkl'
        target_labels_file = data_dir+'/'+ feature + '_labels.pkl'
        target_model_file = data_dir+'/'+ feature + '_model.pkl'
